...
const project: ProjectData = {
  ...
  overview: (
    <>
      <p>
        This is a <strong>portfolio website</strong> built to showcase my work and learn more about modern web
        development. Prior to building this website, my only knowledge of front-end development was using
      ...
      <p>
        ...
        of the community. But I shortly realized that as a prerequsite, I would also need to learn more about HTML, CSS
        and JavaScript. Luckily for me, I stumbled upon
        <strong>
        ...
        which I found to be a great platform for learning these languages and framework.
      </p>
      ...
      <p>
        ...
        there, I spent a lot of time creating and refining the components you see here today.
      </p>
      ...
      <p>
        ...
        about that particular project. To accomplish this, I first created a <i>page.tsx</i> for <i>./projects</i>. I
        then created an array that would hold each project. I could then <i>map</i> through the array to render the
        timeline. But in order for this to work dynamically and for the experience to be consistent, I needed each
        project to be defined in the same manner. For this, I created the following interface:
      </p>
      <pre className="ms-8 text-[12px]">
        <code>
  ...
  iconColor: string;
      ...
      <p>
        ...
        customization per project. So I kept this just a react object under <i>overview</i>.
      </p>
      <p>
        I then created another <i>page.tsx</i> within <i>./projects/[slug]</i> to handle the dynamic rendering of the
        the project detailed pages. We use <i>[slug]</i> to tell Next.js that the URL will get its value from{" "}
        <i>params.slug</i> (which in this case, gets defined in our interface). I then needed to create an{" "}
        <i>async function</i> so that we could <i>await</i> the <i>params object</i>.
      </p>
      <pre className="ms-8 text-[12px]">
        <code>
