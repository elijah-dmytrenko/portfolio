export default function MyStory() {
  return (
    <div className="bg-white/60 dark:bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 mb-8 shadow-xl">
      <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6 text-center lg:text-center">
        My Story
      </h2>
      <div className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <p>
          ...
          To my surprise, this was a rather tedious and manual process with many bottle-necks. 
        ...
        <p>
          ...
          And so energized by this excitement (and naivety), I jumped into the deep-end and set out to conquer programming (whatever that meant).
        </p>
        <br/>
        <p className='font-bold'>
          Quant
        ...
        <p>
          ...
          We were building a scalable, fully customizable multi-asset platform where clients could come and choose their 'alpha blocks' (think legos) to fit their unique needs.
        </p>
        <br/>
        <p>
          However, to my great disappointment in May 2025, this all came to an end. We were shutdown by the Bank's relatively new Exec Team. 
          I'm guessing the Execs decided we were the ugly step-child in the brand (as we were the only systematic team). 
          But that's just my guess and I don't know why--the rationale was never communicated.
        </p>
        <br/>
        <p className='font-bold'>
          What's Next?
