export default function Footer() {
  return (
    <footer className="bg-white/80 backdrop-blur-md dark:bg-gray-900/80 border-t border-gray-200 dark:border-gray-700 py-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left mb-4 md:mb-0">
            {/* Copyright */}
            <div className="mb-2">
              <p className="text-gray-600 dark:text-gray-300 text-sm">© 2025 Elijah Dmytrenko. All rights reserved.</p>
            </div>
