...
import portfolioWebsite from "@/data/projects/portfolio-website";

// Manually import all projects here
const projects: ProjectData[] = [portfolioWebsite];
      ...
      <main className="flex-1 pt-20 px-4 pb-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl lg:text-5xl font-bold text-blue-700 dark:text-blue-200 mb-4">Projects</h1>
            <p className="text-xl text-blue-600 dark:text-blue-300 italic">A collection of my work and experiments</p>
          </div>
          ...
          <div className="space-y-8">
            {projects.map((project) => {
              ...
              return (
                <div
                  key={project.slug}
                  className="bg-white/60 dark:bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300"
                >
                  <div className="flex flex-col lg:flex-row gap-6">
                    <div className="flex-shrink-0">
                      <div
                        className={`w-24 h-24 rounded-xl flex items-center justify-center ${getIconColorClasses(
                          project.iconColor
                        )}`}
                      >
